module.exports = {
    ...
    async execute(client, message, args, prefix) {
        ...
        const comment = [
            ...
            `**1/10**\nЧел, ты...`,
            `**1/10**\nНихуя ты умный.`,
            `**1/10**\nЧел, шутка - это когда должно быть смешно, а не когда хочется ебало набить!`,
            ...
            `**3/10**\nЖелаю тебе закончить 3 класс с такими шутками.`,
            `**3/10**\nДержишь планку! Как всегда хуйня!`,
            `**3/10**\nМммм, хуета!`,
            `**3/10**\nУ меня нет слов... Точнее, есть, но материться плохо!`,
            ...
            `**5/10**\noh dear`,
            `**5/10**\nА дальше чё?`,
            `**5/10**\nЯ поржал, но не сильно.`,
            `**5/10**\nЭто programmist, я фотошоп!`,
            `**6/10**\nёпаресете)`,
            `**6/10**\nА чё?)`,
            `**6/10**\nЧто это было, Пух?`,
            `**6/10**\nОп ахах)`,
            `**6/10**\nнихуя себе че он вытворяет!!!!`,
            `**7/10**\nУ меня нет слов... Точнее, есть, но материться плохо!`,
            `**7/10**\nКакая смешная у тебя получилась шутка! Смеялись всей нейросетью!`,
